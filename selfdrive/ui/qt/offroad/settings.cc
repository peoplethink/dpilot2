...
TUNINGPanel::TUNINGPanel(QWidget* parent) : QWidget(parent) {
    ...
    toggleLayout->addWidget(horizontal_line());
    toggleLayout->addWidget(new CValueControl("CruiseMaxVals1", "ACCEL:0km/h(220)", "속도별 가속도를 지정합니다.(x0.01m/s^2)", "../assets/offroad/icon_road.png", 1, 250, 5));
    toggleLayout->addWidget(new CValueControl("CruiseMaxVals2", "ACCEL:10km/h(200)", "속도별 가속도를 지정합니다.(x0.01m/s^2)", "../assets/offroad/icon_road.png", 1, 250, 5));
    toggleLayout->addWidget(new CValueControl("CruiseMaxVals3", "ACCEL:20km/h(150)", "속도별 가속도를 지정합니다.(x0.01m/s^2)", "../assets/offroad/icon_road.png", 1, 200, 5));
    toggleLayout->addWidget(new CValueControl("CruiseMaxVals4", "ACCEL:30km/h(110)", "속도별 가속도를 지정합니다.(x0.01m/s^2)", "../assets/offroad/icon_road.png", 1, 150, 5));
    toggleLayout->addWidget(new CValueControl("CruiseMaxVals5", "ACCEL:40km/h(65)", "속도별 가속도를 지정합니다.(x0.01m/s^2)", "../assets/offroad/icon_road.png", 1, 100, 5));
    toggleLayout->addWidget(new CValueControl("CruiseMaxVals6", "ACCEL:50km/h(50)", "속도별 가속도를 지정합니다.(x0.01m/s^2)", "../assets/offroad/icon_road.png", 1, 70, 5));
    toggleLayout->addWidget(new CValueControl("CruiseMaxVals7", "ACCEL:70km/h(40)", "속도별 가속도를 지정합니다.(x0.01m/s^2)", "../assets/offroad/icon_road.png", 1, 60, 5));
    toggleLayout->addWidget(new CValueControl("CruiseMaxVals8", "ACCEL:90km/h(30)", "속도별 가속도를 지정합니다.(x0.01m/s^2)", "../assets/offroad/icon_road.png", 1, 50, 5));
    toggleLayout->addWidget(new CValueControl("CruiseMaxVals9", "ACCEL:110km/h(25)", "속도별 가속도를 지정합니다.(x0.01m/s^2)", "../assets/offroad/icon_road.png", 1, 40, 1));
    toggleLayout->addWidget(new CValueControl("CruiseMaxVals10", "ACCEL:130km/h(10)", "속도별 가속도를 지정합니다.(x0.01m/s^2)", "../assets/offroad/icon_road.png", 1, 30, 1));
    toggleLayout->addWidget(horizontal_line());
