...
TUNINGPanel::TUNINGPanel(QWidget* parent) : QWidget(parent) {
    ...
    toggleLayout->addWidget(horizontal_line());
    toggleLayout->addWidget(new CValueControl("LateralTorqueCustom", "TorqueCustom(0)", "", "../assets/offroad/icon_road.png", 0, 2, 1));
    ...
    toggleLayout->addWidget(new CValueControl("LateralTorqueFriction", "TorqueFriction(100)", "", "../assets/offroad/icon_road.png", 0, 1000, 1));
    toggleLayout->addWidget(horizontal_line());
