...
TUNINGPanel::TUNINGPanel(QWidget* parent) : QWidget(parent) {
    ...
    toggleLayout->addWidget(new CValueControl("LongitudinalActuatorDelayLowerBound", "_LADLowerBound(50)", "LONG", "../assets/offroad/icon_road.png", 10, 100, 10));
    toggleLayout->addWidget(new CValueControl("LongitudinalActuatorDelayUpperBound", "_LADUpperBound(50)", "LONG", "../assets/offroad/icon_road.png", 10, 100, 10));
    ...
    toggleLayout->addWidget(new CValueControl("TFollowGap3", "GAP3: Apply TFollow (160)x0.01s", "선행차와의 간격3단계, 속도x시간", "../assets/offroad/icon_road.png", 90, 300, 5));
    toggleLayout->addWidget(new CValueControl("TFollowGap4", "GAP4: Apply TFollow (120)x0.01s", "선행차와의 간격4단계, 속도x시간", "../assets/offroad/icon_road.png", 90, 300, 5));
}
