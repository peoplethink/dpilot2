...
TUNINGPanel::TUNINGPanel(QWidget* parent) : QWidget(parent) {
    ...
    toggleLayout->addWidget(new CValueControl("LongitudinalTuningKpV", "P Gain(100)", "", "../assets/offroad/icon_road.png", 50, 150, 1));
    toggleLayout->addWidget(new CValueControl("LongitudinalTuningKiV", "I Gain(0)", "", "../assets/offroad/icon_road.png", 0, 2000, 5));
    toggleLayout->addWidget(new CValueControl("LongitudinalActuatorDelayLowerBound", "_LADLowerBound(20)", "", "../assets/offroad/icon_road.png", 0, 100, 10));
    toggleLayout->addWidget(new CValueControl("LongitudinalActuatorDelayUpperBound", "_LADUpperBound(60)", "", "../assets/offroad/icon_road.png", 0, 100, 10));
    toggleLayout->addWidget(horizontal_line());
    toggleLayout->addWidget(new CValueControl("CruiseMaxVals1", "ACCEL:0~10km/h(205)", "속도별 가속도를 지정합니다.(x0.01m/s^2)", "../assets/offroad/icon_road.png", 1, 250, 5));
    toggleLayout->addWidget(new CValueControl("CruiseMaxVals2", "ACCEL:10~20km/h(200)", "속도별 가속도를 지정합니다.(x0.01m/s^2)", "../assets/offroad/icon_road.png", 1, 250, 5));
    ...
    toggleLayout->addWidget(new CValueControl("CruiseMaxVals4", "ACCEL:30~40km/h(95)", "속도별 가속도를 지정합니다.(x0.01m/s^2)", "../assets/offroad/icon_road.png", 1, 150, 5));
    toggleLayout->addWidget(new CValueControl("CruiseMaxVals5", "ACCEL:40~50km/h(45)", "속도별 가속도를 지정합니다.(x0.01m/s^2)", "../assets/offroad/icon_road.png", 1, 100, 5));
    toggleLayout->addWidget(new CValueControl("CruiseMaxVals6", "ACCEL:50~70km/h(40)", "속도별 가속도를 지정합니다.(x0.01m/s^2)", "../assets/offroad/icon_road.png", 1, 70, 1));
    toggleLayout->addWidget(new CValueControl("CruiseMaxVals7", "ACCEL:70~90km/h(35)", "속도별 가속도를 지정합니다.(x0.01m/s^2)", "../assets/offroad/icon_road.png", 1, 60, 1));
    toggleLayout->addWidget(new CValueControl("CruiseMaxVals8", "ACCEL:90~110km/h(30)", "속도별 가속도를 지정합니다.(x0.01m/s^2)", "../assets/offroad/icon_road.png", 1, 50, 1));
    ...
    toggleLayout->addWidget(new CValueControl("CruiseMaxVals10", "ACCEL:130km/h이상(10)", "속도별 가속도를 지정합니다.(x0.01m/s^2)", "../assets/offroad/icon_road.png", 1, 30, 1));
    toggleLayout->addWidget(horizontal_line());
