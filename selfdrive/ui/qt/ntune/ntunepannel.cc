...
QList<QList<TuneItemInfo>> nTuneMainWidget::mainItems = {
{
    ...
    TuneItemInfo("common.json", "dampilngfactor", "",
...
},
{
    ...
    TuneItemInfo("scc_v2.json", "longitudinalActuatorDelay", tr("Longitudinal Actuator Delay"),
                 0.5f, 0.1f, 1.0f, 0.05f, 2, "sec"),
    TuneItemInfo("scc_v2.json", "longitudinalTuningkf", tr("값이 클수록 응답성이 좋아짐 "),
                 1.0f, 0.0f, 2.0f, 0.05f, 2),
    TuneItemInfo("scc_v2.json", "stopAccel", tr(""),
                 -2.0f, -5.0f, 5.0f, 0.05f, 2),
    TuneItemInfo("scc_v2.json", "startAccel", tr(""),
                 1.5f, 0.0f, 5.0f, 0.05f, 2),
    TuneItemInfo("scc_v2.json", "stoppingDecelRate", tr(""),
                 0.3f, 0.1f, 1.0f, 0.05f, 2),
    TuneItemInfo("scc_v2.json", "vEgoStopping", tr(""),
                 0.3f, 0.1f, 1.0f, 0.05f, 2),
    TuneItemInfo("scc_v2.json", "vEgoStarting", tr(""),
                 0.3f, 0.1f, 1.0f, 0.05f, 2),
    TuneItemInfo("scc_v2.json", "comfortBrake", tr("값이 클수록 앞차와의 거리가 감소됨."),
