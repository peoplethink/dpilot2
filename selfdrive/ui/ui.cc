...
static void update_model(UIState *s, const cereal::ModelDataV2::Reader &model) {
  ...
  update_blindspot_data(s, lane_lines[1], 0, -0.05, -0.6, &scene.lane_blindspot_vertices[0], max_idx_barrier);
  update_blindspot_data(s, lane_lines[2], 0, -0.05, -0.6, &scene.lane_blindspot_vertices[1], max_idx_barrier);
