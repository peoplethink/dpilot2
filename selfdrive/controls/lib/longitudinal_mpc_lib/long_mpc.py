...
CRUISE_GAP_V = [0.9, 1.2, 1.6, 1.6]

AUTO_TR_BP = [0., 30.*CV.KPH_TO_MS, 50.*CV.KPH_TO_MS, 70.*CV.KPH_TO_MS70.*CV.KPH_TO_MS, 110.*CV.KPH_TO_MS]
AUTO_TR_V = [1.0, 1.05, 1.1, 1.2, 1.3]
