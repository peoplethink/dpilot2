...
_ENTERING_PRED_LAT_ACC_TH = 1.1  # Predicted Lat Acc threshold to trigger entering turn state. //default 1.3 #1.4
_ABORT_ENTERING_PRED_LAT_ACC_TH = 1.1  # Predicted Lat Acc threshold to abort entering state if speed drops.

_TURNING_LAT_ACC_TH = 2.0  # Lat Acc threshold to trigger turning turn state. //default 1.6 : not working, =< 1.4 : working
