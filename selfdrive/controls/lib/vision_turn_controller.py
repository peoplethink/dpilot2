...
_TURNING_LAT_ACC_TH = 0.8  # Lat Acc threshold to trigger turning turn state. //default 1.6 : not working, =< 1.4 : working

_LEAVING_LAT_ACC_TH = 0.7  # Lat Acc threshold to trigger leaving turn state. //default 1.3 : too long
...
_TURNING_ACC_V = [0.6, 0., -1.0]  # acc value
_TURNING_ACC_BP = [0.8, 1.75, 2.4]  # absolute value of current lat acc

_LEAVING_ACC = 0.7  # Confortble acceleration to regain speed while leaving a turn.
